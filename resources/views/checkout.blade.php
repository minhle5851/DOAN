                                ...
                                <div class="info-order">
                                    ...
                                    <ul class="product-order">
                                        ...
                                        <li>
                                            ...
                                            <span class="right brand" id="subtotal">{{Cart::subtotal()}} VND</span>
                                        </li>
                                        <li>
                                            <span class="left">Thanh toán</span>
                                            <span class="right">Thanh toán khi nhận hàng </span>
                                        </li>
                                        <li>
                                            <span class="left">Thanh toán online</span>
                                            <div class="right" id="paypal-button-container"></div>
                                        </li>
                                    </ul>
                                </div>
